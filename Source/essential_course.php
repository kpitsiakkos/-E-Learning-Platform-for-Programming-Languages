...
<body>
    ...
    <h1 class="courses-header">SET UP DESKTOP TUTORIAL </h1>
  
    <div class="container">
        <iframe src="https://www.youtube.com/embed/i_23KUAEtUM"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

    <h1 class="courses-header">CAPILOT EXTENSIONS TUTORIAL </h1>

    <div class="container">
        <iframe src="https://www.youtube.com/embed/Fi3AJZZregI"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>


    <h1 class="courses-header">TABNINE EXTENSIONS TUTORIAL </h1>

    <div class="container">
      <iframe src="https://www.youtube.com/embed/D_p4nLV0H9Q"
         allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

    <h1 class="courses-header">PRETTIER EXTENSIONS TUTORIAL </h1>

    <div class="container">
      <iframe src="https://www.youtube.com/embed/DqfQ4DPnRqI"
         allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
