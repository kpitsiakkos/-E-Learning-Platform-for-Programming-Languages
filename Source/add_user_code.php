...
//  if (isset($_POST['save_user_button'])){
...
//    $query = "INSERT INTO user (username, first_name, last_name, email, user_type) VALUES (:username, :first_name, :last_name, :email, :user_type)"; 
//    $execute_query = $dbConn->prepare($query);
...
//    $execute = $execute_query->execute($data);

//    if($execute){
//       $_SESSION['message']="User details updated successfully!";
//       header('Location: ../admin.php');
//    }else{
//       $_SESSION['message']="User details not updated successfully!";
//       header('Location: ../admin.php');
//    }
