...
<body>
    ...
    <div class="dashboard-options">
        ...
        <nav class="options">
            ...
            <a href="contact_us.html"><i class="fas fa-concierge-bell"></i><span>Contact us</span></a>
            <a href="about_us.html"><i class="fas fa-info"></i><span>About us</span></a>
    ...
    if(isset($_POST["update-profile"])) {
        ...
        // if(!empty($previous_password) || !empty($new_password) || !empty($again_password)) {
        //     if($previous_password !=  $old_password) {
        //         echo "The old password  is incorrect!";
        //     } elseif ($new_password != $again_password) {
        //         echo "The new passwords do not match!";
        //     } else {
        //         $change_password = $user -> $dbConn->prepare(("UPDATE user SET password = ? WHERE id = ?"));
        //         $change_password -> execute([$new_password, $user_id]);
        //         echo "The new password has been set successfully.";
        //     }
        // }
    } 
    ?>
